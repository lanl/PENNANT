...
public:
  ...
  static void setCornerDiv(double* c0area, double* c0div, double* c0evol,
  ...
  static void setQCnForce(const double* c0div, const double* c0du,
      const double* c0evol, double2* c0qe, const int sfirst, const int slast,
      const double2* pu, const double* zrp, const double* zss,
      const double* elen, const double qgamma, const double q1, const double q2,
      const int* map_side2zone, const int* zone_pts_ptr,
      const int* map_side2pt1, const int* map_side2pt2,
      const int* map_side2edge);

  static void setForce(const double* c0area, const double2* c0qe, double* c0cos,
      double2* sfqq, const int sfirst, const int slast, const double* elen,
      const int* map_side2zone, const int* zone_pts_ptr,
      const int* map_side2edge);
