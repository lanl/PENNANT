...
void QCS::calcForce(
    ...
    setCornerDiv(c0area, c0div, c0evol, c0du, c0cos, sfirst, slast,
            ...
            map_side2zone, map_side2pt1, zone_pts_ptr,
    ...
    setVelDiff(sfirst, slast,
            ...
            pu, zss, zdu, elen,
            pt_x_pred, map_side2pt1, map_side2zone,
...
void QCS::setCornerDiv(
    ...
    for (int c = cfirst; c < clast; ++c) {
        ...
        int z0 = z - zfirst;
        int c0 = c - cfirst;
        int p = LocalMesh::mapSideToPt2(s, map_side2pt1, map_side2zone, zone_pts_ptr);
        // Points
        ...
        const int* map_side2edge)
{
    ...
    for (int c = cfirst; c < clast; ++c) {
        ...
        int p2 = LocalMesh::mapSideToPt2(s4, map_side2pt1, map_side2zone, zone_pts_ptr);
