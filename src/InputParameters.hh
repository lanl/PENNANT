...
struct InputParameters {
    ...
    std::vector<double> subregion_; // JPG TODO Legion don't like vectors // bounding box for a subregion
                                    // if nonempty, should have 4 entries:
                                    // xmin, xmax, ymin, ymax
    bool write_xy_file_;            // flag:  write .xy file?
    bool write_gold_file_;          // flag:  write Ensight file?
    std::string meshtype_;          // JPG TODO Legion don't like strings // generated mesh type
