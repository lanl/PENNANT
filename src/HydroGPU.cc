...
__global__ void gpuInvMap(const int* mapspkey,
                          const int* mapspval,
                          int* mappsfirst,
                          int* mapssnext)
{
...
__device__ void applyFixedBC(const int p,
                             const double2 px,
                             double2 &pu,
                             double2 &pf,
                             const double2 vfix,
...
__device__ void hydroCalcWork(const int s,
                              const int s0,
                              const int z,
                              const int p1,
                              const int p2,
...
__device__ void hydroCalcDtCourant(const int z,
...
__device__ void hydroCalcDtVolume(const int z,
...
__device__ void hydroFindMinDt(const int z,
                               const int z0,
                               const int zlength,
                               const double dtz,
                               const int idtz,
...
__device__ void hydroCalcDt(const int z,
                            const int z0,
                            const int zlength,
                            const double* __restrict__ zdu,
                            const double* __restrict__ zss,
...
__device__ void calcZoneCtrs_SideVols_ZoneVols(const int s,
                                               const int s0,
                                               const double2 pxp1,
                                               const double2 pxp2,
...
__device__ void pgasCalcStateAtHalf(const int z,
                                    const double rx,
                                    const double zvolp,
                                    double zvolz,
                                    double zez,
...
static __device__ void ttsCalcForce(const int s,
                                    const int z,
                                    const double zareap,
                                    const double zrp,
                                    const double zssz,
...
__device__ void qcsSetCornerDiv(const int s,
                                const int s0,
                                const int s4,
                                const int s04,
                                const int z,
...
__device__ void qcsSetVelDiff(const int s,
                              const int s0,
                              const int p1,
                              const int p2,
                              const double2 pxpp1,
...
void computeChunks(const int nums,
                   const int numz,
                   const int* mapsz,
                   const int chunksize,
                   int& numsch,
...
void hydroInit(const int numpH,
               const int numzH,
               const int numsH,
               const int numcH,
               const int numeH,
...
void hydroGetData(double *zareaH,
                  double *zetotH,
                  double *zvolH,
                  const int numpH,
                  const int numzH,
